...
另外，我们可以设置`Templator`在笔记库启动的时候自动运行上述脚本来更新urls.json：
...
(function () {
    ...
    const urlListUrl = "https://raw.githubusercontent.com/Huangzh2001/Read_It_Later/main/obsidian-urls/urls-with-status.json";
    const currentUrl = window.location.href;
