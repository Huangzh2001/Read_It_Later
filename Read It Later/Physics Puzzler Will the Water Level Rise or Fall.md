---
date: "2025-08-10T22:16:29+08:00"
url: "https://www.physicswithelliot.com/melting-ice-classic-notes"
status:
---
![](https://www.youtube.com/watch?v=2ByZhkCHaCw)
...
Resolving this question is all about understanding the buoyant force, which is what my last video was about. So if you haven't watched [that one](https://www.physicswithelliot.com/buoyant-help-room-notes) yet, you should go watch it first, and then come back here to finish. The key thing we learned was Archimedes' principle: when you sink an object under the surface of a fluid, it exerts an upward force on the object that's equal to the weight of however much fluid was displaced. So let's see how Archimedes' principle clears up this question.

When we float the ice cube on the water, part of the volume falls below the surface of the liquid, displacing whatever water had been there. Call that volume $VF$ . We learned that the upward buoyant force on the ice cube equals the weight of however much liquid was displaced: that's the density of the liquid $ρF$ , times the volume $VF$ , times $g$ : $FB=ρFVFg$ .
...
- [How Archimedes Cleverly Solved the Buoyant Force Puzzle 2000 Years Ago: Physics Help Room](https://www.physicswithelliot.com/buoyant-help-room-notes)
