...
## （8）功能8：如何将视频的字幕扒下来，放在视频所在的markdown文件中

1. 如果你保存的是哔哩哔哩的视频，因为它一般会有自动生成的字幕，所以你可以安装一个浏览器插件：**哔哔君 - bilibili哔哩哔哩字幕列表**[^4]。然后你就可以通过复制视频旁边的字幕到视频所在的markdown文件中。（youtube可能也有类似的工具，比如这个网站：）
