...
```js
// ==UserScript==
// @name         Obsidian URL Checker
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  在网页角落提示是否已收藏到 Obsidian
// @match        *://*/*
...
(function () {
    ...
    console.log("[Obsidian URL Checker] 脚本启动");

    // GitHub 文件地址（注意 raw 链接）
    ...
    GM_xmlhttpRequest({
        ...
        url: urlListUrl,
        onload: function (res) {
            console.log("[Obsidian URL Checker] 成功加载 URL 列表");
            ...
            try {
                ...
                console.log("[Obsidian URL Checker] 当前页面是否已收藏：", found);

                if (found) {
                    showNotice("✅ 已收藏于 Obsidian");
                }
            } catch (err) {
                console.error("[Obsidian URL Checker] 解析 JSON 失败", err);
            }
        },
        onerror: function (err) {
            console.error("[Obsidian URL Checker] 加载 URL 列表失败", err);
        }
    });
